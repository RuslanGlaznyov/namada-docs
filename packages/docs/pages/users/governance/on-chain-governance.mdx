...
Дії можуть бути як "додати", так і "видалити", а адреса - це адреса 
стюарда, якого потрібно додати або видалити. Таким чином, ви можете додати або видалити декілька 
...
<Callout>
Поле даних для пропозицій PGF містить як безперервні, так і ретроактивні дії з фінансування PGF. 
В рамках кожної дії користувач може включити кілька платежів у вигляді вектора. 
Для кожного платежу в полі "Адреса" вказується адреса одержувача, а також сума негрошової допомоги, яку він отримає 
а також суму нефінансової допомоги, яку він отримає. Для безперервного фінансування PGF зазначена сума 
зазначена сума буде надсилатися в кінці кожної епохи. Існує також можливість видалити реципієнта 
з безперервного фінансування PGF, вказавши вже існуючий платіж безперервного фінансування, а потім включивши до нього 
фінансування, а потім також включивши дію "вилучити". Для ретроактивного фінансування PGF, 
вказана сума буде надіслана негайно.
...
Голосувати за пропозиції можуть лише делегати та делегатки. Якщо ви належите до однієї з цих категорій, ви можете відправити голос за допомогою наступної команди:
...
де `--голосування' може бути як `yay'(так), так і `nay'(ні).

## Перевірте результат

Як тільки журнал досягне епохи, визначеної в json як `voting_end_epoch`, голоси більше не прийматимуться.
