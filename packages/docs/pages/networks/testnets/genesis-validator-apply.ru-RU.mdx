...
Следуйте данному руководству по созданию файлов [валидатора "до генезиса"](../../operators/validators/genesis-validator-setup.mdx#pre-genesis).
...
<Callout>
Поле tendermint\_node\_key названо так из соображений наследования. На самом деле это открытый ключ консенсуса CometBFT.
</Callout>
