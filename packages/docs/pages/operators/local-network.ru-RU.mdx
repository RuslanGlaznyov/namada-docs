...
Для работы в локальной сети Namada должна быть установлена [из исходного кода](../introduction/install/source.mdx).
...
2. Должна быть установлена библиотека Python pip https://pypi.org/project/toml/.
...
# Некоторые токены присутствующие в генезисе.
